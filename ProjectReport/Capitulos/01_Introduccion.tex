...
Para comenzar, se ha utilizado Android Studio para la creación de la aplicación de identificación de objetos. Para entrenar y obtener el modelo necesario para su correcto funcionamiento se ha creado un \textit{script} en Python utilizando las librerías de Numpy y Tensorflow; como editor se ha utilizado PyScripter. Toda esta primera parte se ha basado en los ejemplos disponibles sobre Tensorflow Lite que se pueden encontrar en su blog\footnote{\url{https://www.tensorflow.org/lite/?hl=es_419}}.
...
Por último, se ha usado GitHub como plataforma para el control de versiones y TexMaker para el desarrollo de la memoria a partir de la plantilla \texis.
