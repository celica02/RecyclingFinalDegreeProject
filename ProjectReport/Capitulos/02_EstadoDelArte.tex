...
\figura{EsquemaRedNeuronal.png}{width=1\textwidth}{fig:RN}{Estructura de una red neuronal artificial.}
...
\todo{Añadir comparaciones con otras opciones: PyTorch(el cual está un poquito en pañales) y Coffe2 (resultados similares pero con menos información disponible)}
