...
Se observa que la mayoría de las opciones se mantienen casi todo el proceso en una tasa de acierto mayor del 90\%. Los casos en los que se puede contemplar una caída de la exactitud, son aquellos que cuentan con mayor porcentaje de imágenes sintéticas para el entrenamiento. Esto se debe a que al haber visto muy pocas imágenes reales de este material durante el entrenamiento ahora en el \textit{test} no las identifica como metal, provocando que la tasa de aciertos decrezca notablemente.
