...
\todo{separación imágenes entrenamiento y test}
Al final del proceso explicado durante el presente capítulo, se recogieron los siguientes conjuntos de imágenes:

De imágenes reales se obtuvieron varios datasets desde la página Kaggle\footnote{\url{https://www.kaggle.com/}}. . Se cuenta con tres materiales diferentes, plástico, vidrio y metal; de los cuales se cuenta con al rededor de mil imágenes para cada uno.
