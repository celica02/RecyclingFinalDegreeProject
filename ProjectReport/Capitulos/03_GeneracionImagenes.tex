...
Unity es una herramienta de creción de videojuegos creada por Unity 
Technologies. Unity no se limita al desarrollo de videojuegos únicamente,
sino que su uso está más extendido; es una herramienta utilizada en muchos
otros sectores como en el cinemático, el de transporte y la producción o en
 arquitectura, ingeniería y construcción\footnote{https://unity.com/es}.
