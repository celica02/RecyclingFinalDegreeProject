...
Por último, el tiempo de inferencia de la aplicación es de unos 200ms, aproximadamente 700ms en la de \textit{test}, utilizando la CPU del dispositivo. En cambio, si se realiza con la GPU estos valores se reducen a al rededor de la mitad.

\begin{figure}
	\centering
	\subfloat[Botella de vino]
		{{\includegraphics[width=0.4\textwidth]{Imagenes/appBotellaVino}}}
	\qquad
	\subfloat[Taza de cristal]
		{{\includegraphics[width=0.4\textwidth]{Imagenes/appVasoCristal}}}
...
\begin{figure}
	...
	\subfloat[Bote de limpieza de plástico]
		{{\includegraphics[width=0.4\textwidth]{Imagenes/appDetergente}}}
	\qquad
	\subfloat[Botella de plástico de refresco]
		{{\includegraphics[width=0.4\textwidth]{Imagenes/appBotellaCola}}}
...
\begin{figure}
	\centering
	\subfloat[]
		{{\includegraphics[width=0.4\textwidth]{Imagenes/appBotellaPlastico1}}}
	\qquad
	\subfloat[]
		{{\includegraphics[width=0.4\textwidth]{Imagenes/appBotellaPlastico2}}}
